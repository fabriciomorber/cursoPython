...
iface = gr.Interface(
    ...
    inputs=[
        ...
        gr.Textbox(label="Lista de Itens", placeholder="Item1\nItem2"),
    ...
    outputs=[
        ...
        gr.Textbox(label="Cor selecionadas"),
        gr.Textbox(label="Opções selecionadas")
    ],
    title="Verificador de Tipos de Entrada e Saída",
    description="Insira um texto, um número, uma lista de itens, uma cor e opções para ver como a entrada é procesada.",
)
